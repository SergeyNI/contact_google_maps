...
// import * as jquery from "jquery-2.0.0.min"
...
window.initMap = function () {
  ...
  $.get('http://localhost:3000/markers/index',function(data){
    $.each( data, function( key, dataMarker ) {
      console.log(key, dataMarker);
      var point = {lat: dataMarker.lat,lng: dataMarker.lng}
      var marker = new google.maps.Marker({
        position: dataMarker,
        id: dataMarker.id,
        name: dataMarker.name,
        map: map
      })
      markers.push(marker)
      ...
      marker.addListener("click", (evt) => {
        infowindow.setContent("<h1>"+this.name+"</h1>");
        infowindow.open(map)
      });
